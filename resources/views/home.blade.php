...
<body>
    ...
    <div class="mainbody">
                ...
                <div class="row">
                    <div class="col-md-6" style="padding-top: 100px;">
                        ...
                        <div class="btn-play d-flex">
                            ...
                            <i class="fas fa-gamepad" style="text-decoration: none;"> <i class="custom-link" style="text-decoration: none; color:black;font-style: italic;" onclick="login()">Play!</i></i>
                            </button>
                        </div>
                    </div>    
            ...
            <div class="container-fluid container2">
                <div class="row">
                    <div class="col-md-6 pd-10">
                        <h1 class="about-heading" style="color:black; font-weight: bold;font-size: xxx-large;"> About us </h1>
                        <br/>
            ...
            <div class="container-fluid container3">
                <div class ="para1">
                    <h1 class="morething-heading" style="color:black; font-weight: bold;font-size: xxx-large;padding-bottom: 30px;margin-left: 100px;">More things</h1>
                    <p id ="animated-text">
                        <p class="text-center" >
